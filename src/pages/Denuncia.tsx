...
export default function Denuncia() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      uploadTask.on(
        ...
        async () => {
          // Guardar la ruta interna en Firestore (no URL pública)
          ...
          await addDoc(collection(db, "denuncias"), {
            ...
            numero_averiguacion,
            fecha_denuncia,
            documentoPath: storagePath, // Ruta interna en Storage
            estado: "pendiente",
            createdAt: Timestamp.now(),
          });

          alert(
            "✅ Denuncia enviada correctamente. Será revisada por nuestro equipo."
          );
          setLoading(false);
  ...
  return (
    <div className="denuncia-container">
      <button onClick={() => navigate("/verificacion")} className="btn-volver">
        ← Volver a Verificación
      </button>

      <h1>Formulario de Denuncia en Línea</h1>
      <p className="aviso-legal">
        ⚖️ Para proteger la integridad de terceros, sólo aceptamos denuncias
        acompañadas de documentación oficial emitida por el Ministerio Público.
        Toda denuncia será verificada antes de ser publicada.
      </p>
      ...
      <form className="denuncia-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group declaracion-legal">
          ...
          >
            ...
            />
            <span>
              ⚠️ <strong>Declaro bajo protesta de decir verdad</strong> que la
              información proporcionada es verídica y está sustentada en
              documentación oficial. Entiendo que enviar información falsa puede
